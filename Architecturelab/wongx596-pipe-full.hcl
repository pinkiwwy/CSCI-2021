...
## Description:
##
## 1. IIADDQ instruction is implemented here same as the seq version.
## 2. Update condition code E_icode with IIADDQ
##
####################################################################
##
## Stage:           iaddq
...
# added iaadq to list of instruction(valid)
...
#iaddq requires regid byte

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL, IIADDQ };
#iaddq requires constant word (valC)
...
bool set_cc = E_icode in {IOPQ, IIADDQ} &&  #set cc if iaddq in E 
